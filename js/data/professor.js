    ...
    tbody.innerHTML = "";
        ...
        tbody.innerHTML += `
            <tr>
                ...
                <td>${professor.departamento ? professor.departamento.nome : 'Nenhum'}</td>
        ...
        professor.turmas.forEach(turma => {
            tbodyTurmas.innerHTML += `
                <tr>
                    <td>${turma.id}</td>
                    <td>${turma.nome} </td>
                    <td>${turma.disciplinaNome || 'Nenhuma'}</td>
                    <td>${turma.cursoNome || 'Nenhum'}</td>
                    <td>${professor.pessoa.nome}</td>
                    <td>${turma.sala}</td>
                    <td>${turma.horario}</td>
                    <td>${turma.nvagas}</td>
...
async function editarProfessor(id) {
    ...
    document.getElementById("nomep").value = professor.pessoa.nome || '';
    document.getElementById("cpfp").value = professor.pessoa.cpf || '';
    document.getElementById("generoDropdown").value = professor.pessoa.genero || '';
    document.getElementById("emailp").value = professor.pessoa.email || '';
    document.getElementById("telefonep").value = professor.pessoa.telefone || '';
